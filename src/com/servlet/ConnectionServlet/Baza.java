...
public class Baza {
	private String typyEventKsiazek[] = {"W przyszlosci", "W trakcie", "Skonczone", "Przerwana"};
	private String typyEventFilmow[] = {"W przyszlosci", "W trakcie", "Skonczone", "Przerwana"};
	private String typyEventGier[] = {"W przyszlosci", "W trakcie", "Skonczone", "Przerwana"};
    ...
    {
    	ArrayList<String> tablica = new ArrayList<String>();
    	String sql = "SELECT BookEvent.Date AS Data, Book.Title AS Tytul, Book.Creator AS Tworca, "
